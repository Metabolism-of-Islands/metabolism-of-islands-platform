...
urlpatterns = baseline_urlpatterns + [
    ...
    path("projects/<int:id>/results/", views.project, {"page": "results"}, name="project_results"),
    path("projects/<int:id>/sensitivity/", views.project, {"page": "sensitivity"}, name="project_sensitivity"),
